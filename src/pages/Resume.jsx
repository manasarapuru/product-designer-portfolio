      ...
      <main className="resume__main">
        ...
        <div className="resume__header">
          ...
          <a
            ...
            aria-label="Download resume PDF (link coming soon)"
          >
            <DownloadIcon />
            Download Resume
          </a>
  ...
  return (
    <div className="whoiam">
      ...
      <div className="whoiam__section">
        <span className="whoiam__label">Now</span>
      ...
      <div className="whoiam__section">
        <span className="whoiam__label">The Work</span>
        <div className="whoiam__two-col">
          <div>
            <p className="whoiam__sublabel">Focus areas</p>
            <ul className="whoiam__list">
              <li>Reducing cognitive overload in data-heavy environments</li>
              <li>Structuring complex workflows into intuitive interaction models</li>
              <li>Integrating AI as decision support, not a black box</li>
              <li>Connecting interface design directly to computational logic</li>
            </ul>
          </div>
          <div>
            <blockquote className="whoiam__quote serif">
              "The best interface is the one you stop noticing — because you're already thinking about the decision, not the tool."
            </blockquote>
            <p className="whoiam__body">
              I came to design through data. Before I picked up Figma, I was building pipelines, wrangling datasets, and trying to make sense of outputs that took days to generate. That experience lives in every design decision I make.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="whoiam__section">
        <span className="whoiam__label">Before Design</span>
        <p className="whoiam__lead serif">I used to be a scientist.</p>
        <p className="whoiam__body">
          Not metaphorically. I spent years as a bioinformatician — processing genomic data, building computational pipelines, and working inside research and biotech teams. That's where my obsession with clarity was born. When a pipeline runs for 72 hours and produces a result nobody can interpret, you learn very quickly that the output is only as good as its presentation.
        </p>
        <p className="whoiam__body">
          Science taught me to ask: <em>what does this actually mean for the person reading it?</em> Design gave me the tools to answer it.
        </p>
      </div>
...
const EXPERIENCE = [
  ...
  },
  {
    ...
    bullets: [
      'Developed a Python-based analytical pipeline (Pandas, NumPy, Matplotlib, Scikit-Learn) to model cell morphology metrics derived from IncuCyte imaging. Evaluating machine learning approaches to assess whether custom models could improve phenotypic classification accuracy beyond the instrument’s default analysis software.',
      'Conducted transcriptomic analysis of RNA-Seq, Single-cell RNA-Seq, and Tandem Repeat genomic datasets to investigate disease-associated gene expression patterns and molecular signatures in Huntingtons disease, implementing differential expression workflows in R using DESeq2 and ggplot2.',
      ,
    ],
  },
  {
    ...
    bullets: [
      ...
      'Served as project lead/manager, coordinating team efforts, defining scope, and aligning development with user needs and workflow goals',
      'Owned the frontend design and development, creating interactive visualizations that enabled users to: explore gene expression patterns, compare brain regions and disease states, and retrieve insights without requiring deep computational expertise',
      'Translated complex multi-dimensional data into an intuitive, exploratory interface, improving how users learn from and interact with scientific data',
      'The group designed and developed the full-stack web application  using HTML, CSS, JavaScript, Python, and SQL',
    ],
  },
  {
  ...
  },
  {
    ...
    bullets: [
      'Conducted phylogenetic and protein visualization analyses to understand evolutionary relationships and potential functional role of Candidatus Saccharibacteria in the oral microbiome',
      ],
  },
];
...
const EDUCATION = [
  ...
  },
  {
    ...
    note: 'First class honours. Specialisation in computational and molecular biology.',
  },
  {
    degree: 'Full Stack Developer Certification',
    institution: ' Coursera ',
    period: 'Nov 2023 - April 2024',
    note: 'Nielsen Norman Group, Reforge, and building real products.',
  },
  {
  ...
  {
    degree: 'B.S. Microbiology & Chemistry Minor',
      ...
      {EDUCATION.map((edu, i) => (
        <div key={i} className="resume__job">
          ...
          <div className="resume__job-right">
            ...
            <p className="resume__job-note">{edu.note}</p>
          </div>
        </div>
      ))}
    </div>
...
const SKILL_GROUPS = [
  {
    ...
    color: '#ff6b6b',
    soft: '#fff0f0',
    skills: ['Figma', 'Prototyping', 'Design Systems', 'User Flows', 'Wireframing', 'High-Fidelity UI', 'UX Research'],
  },
  {
    label: 'Development',
    color: '#4ecdc4',
    soft: '#d4f5f3',
    skills: ['React', 'JavaScript', 'HTML & CSS', 'Python', 'R / Shiny', 'Vite', 'Git'],
  },
  {
    label: 'Domain',
    color: '#c8a800',
    soft: '#fffce0',
    skills: ['Bioinformatics', 'Genomics', 'Data Visualisation', 'Multi-omics', 'Research Methods'],
  },
  {
    label: 'Tools & Process',
    color: '#1a535c',
    soft: '#d4eced',
    skills: ['AI-assisted design', 'Notion', 'Linear', 'Handoff & Specs', 'Agile / Scrum'],
  },
];
    ...
    <div className="resume__skills">
      {SKILL_GROUPS.map(group => (
        <div key={group.label} className="resume__skill-group">
          <h3 className="resume__skill-heading" style={{ color: group.color }}>
            {group.label}
          </h3>
          <div className="resume__skill-chips">
            {group.skills.map(s => (
              <span key={s} className="resume__chip" style={{ background: group.soft, color: group.color }}>
                {s}
              </span>
            ))}
          </div>
